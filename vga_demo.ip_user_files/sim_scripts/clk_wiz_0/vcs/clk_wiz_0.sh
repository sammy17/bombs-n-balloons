...
#
# Generated by Vivado on Mon Oct 24 16:06:01 -0400 2022
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/C:/Users/chath/vga_demo/vga_demo.ip_user_files/ipstatic" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/C:/Users/chath/vga_demo/vga_demo.ip_user_files/ipstatic" \
    "$ref_dir/../../../../vga_demo.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../vga_demo.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
